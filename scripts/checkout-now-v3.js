...
function getNextPageSlugForRedirect() {
  const normalize = (value) => {
    if (!value) return "";
    return value.startsWith("/69ba5010deba85a3f7853271-preview") ? value : (value.startsWith("/") ? "/69ba5010deba85a3f7853271-preview" + value : "/69ba5010deba85a3f7853271-preview/" + value);
  };
...
const getVrioCampaignInfoBasedOnPaymentMethod = (isVipUpsell) => {
    const vrioCampaigns = [{"_id":"69af575f7b54ee5b8e1530d5","integration":[{"_id":"68de8b4ba7998abc5f77b02a","workspace":"develop","platform":"vrio","description":"production","fields":{"publicApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg","internalApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg"},"status":"active","createdAt":1758437407128,"updatedAt":1759415115447,"__v":0,"category":"CRM","id":"68de8b4ba7998abc5f77b02a"}],"externalId":"102","name":"Black Falcon Drone - Network - (1)","currency":"USD","countries":[223,38],"metadata":{"campaign_id":102,"campaign_name":"","payment_type_id":1,"campaign_active":true,"campaign_prepaid":true,"campaign_payment_method_required":true,"campaign_group_transactions":true,"campaign_global_js":"","campaign_global_seo_title":"","campaign_global_seo_keywords":"","campaign_global_seo_description":"","date_created":"2026-03-09 23:27:28","created_by":0,"date_modified":"2026-03-09 23:27:28","modified_by":0,"campaign_notes":"","offers":[],"shipping_profiles":[],"campaignId":"102","externalId":102,"description":"","payment_methods":["amex","discover","visa","master"],"alternative_payments":[],"countries":[{"iso_numeric":840,"calling_code":"1","id":223,"name":"United States of America","iso_2":"US","iso_3":"USA"},{"iso_numeric":124,"calling_code":"1","id":38,"name":"Canada","iso_2":"CA","iso_3":"CAN"}]},"funnels":[],"createdAt":1773073684924,"updatedAt":1773098848298,"packages":[],"status":"active","platform":"vrio","__v":0,"id":"69af575f7b54ee5b8e1530d5"}];
...
const DEFAULT_OFFER_ID = '103';
const getVrioOfferInfoByProductId = (productId) =>
  ((productId) => {
    const vrioOffers = [{"id":103,"offerTypeId":2,"name":"Black Falcon Drone - VIP","items":[{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":24.99,"shippable":false}]},{"id":102,"offerTypeId":1,"name":"Black Falcon Drone - Network","items":[{"name":"1x Drone","id":593,"quantity":1,"price":0,"shippable":false},{"name":"1x Drone Filter","id":605,"quantity":1,"price":0,"shippable":false},{"name":"1x Drone Propeller Set Upgrade (Set of 8)","id":610,"quantity":1,"price":0,"shippable":false},{"name":"2x Drone","id":594,"quantity":1,"price":0,"shippable":false},{"name":"2x Drone Filters","id":606,"quantity":1,"price":0,"shippable":false},{"name":"2x Drone Propeller Set Upgrade (Set of 16)","id":611,"quantity":1,"price":0,"shippable":false},{"name":"3x Drone Filters","id":607,"quantity":1,"price":0,"shippable":false},{"name":"3x Drone Propeller Set Upgrade (Set of 24)","id":612,"quantity":1,"price":0,"shippable":false},{"name":"4x Drone","id":595,"quantity":1,"price":0,"shippable":false},{"name":"4x Drone Filters","id":608,"quantity":1,"price":0,"shippable":false},{"name":"4x Drone Propeller Set Upgrade (Set of 32)","id":613,"quantity":1,"price":0,"shippable":false},{"name":"5x Drone Filters","id":609,"quantity":1,"price":0,"shippable":false},{"name":"5x Drone Propeller Set Upgrade (Set of 40)","id":614,"quantity":1,"price":0,"shippable":false},{"name":"Black Falcon Drone   Journey Package Protection","id":774,"quantity":1,"price":0,"shippable":false},{"name":"Black Falcon Drone - 3 Year Warranty","id":773,"quantity":1,"price":0,"shippable":false},{"name":"Drone","id":587,"quantity":1,"price":0,"shippable":true},{"name":"Drone Dual Camera Upgrade","id":1791,"quantity":1,"price":0,"shippable":false},{"name":"Drone Filter - Single","id":590,"quantity":1,"price":0,"shippable":false},{"name":"Drone Filter - Single","id":589,"quantity":1,"price":0,"shippable":true},{"name":"Drone Propeller Blade - 8 Pieces","id":591,"quantity":1,"price":0,"shippable":true},{"name":"Drone Travel Case Upgrade","id":1792,"quantity":1,"price":0,"shippable":false},{"name":"Dual Camera UPGRADE","id":588,"quantity":1,"price":0,"shippable":false},{"name":"Duo Pro Pack UPGRADE","id":599,"quantity":1,"price":0,"shippable":false},{"name":"Family Pack UPGRADE","id":600,"quantity":1,"price":0,"shippable":false},{"name":"Pro Pack UPGRADE","id":598,"quantity":1,"price":0,"shippable":false},{"name":"Special 1x EXTRA Black Falcon Drone","id":775,"quantity":1,"price":0,"shippable":false},{"name":"Special 1x EXTRA Black Falcon Drone","id":776,"quantity":1,"price":0,"shippable":false},{"name":"Travel Drone Case - UPGRADE","id":592,"quantity":1,"price":0,"shippable":false}]}];
...
const getPrices = () => {
  return [{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":24.99,"shippable":false,"fullPrice":24.99,"finalPrice":24.99,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0},{"name":"1x Drone","id":593,"quantity":1,"price":0,"shippable":false,"fullPrice":99,"finalPrice":99,"productName":"1x Drone","discountAmount":0,"discountPercentage":0},{"name":"1x Drone Filter","id":605,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x Drone Filter","discountAmount":0,"discountPercentage":0},{"name":"1x Drone Propeller Set Upgrade (Set of 8)","id":610,"quantity":1,"price":0,"shippable":false,"fullPrice":49.99,"finalPrice":49.99,"productName":"1x Drone Propeller Set Upgrade (Set of 8)","discountAmount":0,"discountPercentage":0},{"name":"2x Drone","id":594,"quantity":1,"price":0,"shippable":false,"fullPrice":138,"finalPrice":138,"productName":"2x Drone","discountAmount":0,"discountPercentage":0},{"name":"2x Drone Filters","id":606,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"2x Drone Filters","discountAmount":0,"discountPercentage":0},{"name":"2x Drone Propeller Set Upgrade (Set of 16)","id":611,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"2x Drone Propeller Set Upgrade (Set of 16)","discountAmount":0,"discountPercentage":0},{"name":"3x Drone Filters","id":607,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"3x Drone Filters","discountAmount":0,"discountPercentage":0},{"name":"3x Drone Propeller Set Upgrade (Set of 24)","id":612,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"3x Drone Propeller Set Upgrade (Set of 24)","discountAmount":0,"discountPercentage":0},{"name":"4x Drone","id":595,"quantity":1,"price":0,"shippable":false,"fullPrice":236,"finalPrice":236,"productName":"4x Drone","discountAmount":0,"discountPercentage":0},{"name":"4x Drone Filters","id":608,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"4x Drone Filters","discountAmount":0,"discountPercentage":0},{"name":"4x Drone Propeller Set Upgrade (Set of 32)","id":613,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"4x Drone Propeller Set Upgrade (Set of 32)","discountAmount":0,"discountPercentage":0},{"name":"5x Drone Filters","id":609,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"5x Drone Filters","discountAmount":0,"discountPercentage":0},{"name":"5x Drone Propeller Set Upgrade (Set of 40)","id":614,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"5x Drone Propeller Set Upgrade (Set of 40)","discountAmount":0,"discountPercentage":0},{"name":"Black Falcon Drone   Journey Package Protection","id":774,"quantity":1,"price":0,"shippable":false,"fullPrice":3.5,"finalPrice":3.5,"productName":"Black Falcon Drone   Journey Package Protection","discountAmount":0,"discountPercentage":0},{"name":"Black Falcon Drone - 3 Year Warranty","id":773,"quantity":1,"price":0,"shippable":false,"fullPrice":9.95,"finalPrice":9.95,"productName":"Black Falcon Drone - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"name":"Drone Dual Camera Upgrade","id":1791,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Drone Dual Camera Upgrade","discountAmount":0,"discountPercentage":0},{"name":"Drone Filter - Single","id":590,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Drone Filter - Single","discountAmount":0,"discountPercentage":0},{"name":"Drone Travel Case Upgrade","id":1792,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Drone Travel Case Upgrade","discountAmount":0,"discountPercentage":0},{"name":"Dual Camera UPGRADE","id":588,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Dual Camera UPGRADE","discountAmount":0,"discountPercentage":0},{"name":"Duo Pro Pack UPGRADE","id":599,"quantity":1,"price":0,"shippable":false,"fullPrice":99.98,"finalPrice":99.98,"productName":"Duo Pro Pack UPGRADE","discountAmount":0,"discountPercentage":0},{"name":"Family Pack UPGRADE","id":600,"quantity":1,"price":0,"shippable":false,"fullPrice":199.96,"finalPrice":199.96,"productName":"Family Pack UPGRADE","discountAmount":0,"discountPercentage":0},{"name":"Pro Pack UPGRADE","id":598,"quantity":1,"price":0,"shippable":false,"fullPrice":49.99,"finalPrice":49.99,"productName":"Pro Pack UPGRADE","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Black Falcon Drone","id":775,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Black Falcon Drone","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Black Falcon Drone","id":776,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Black Falcon Drone","discountAmount":0,"discountPercentage":0},{"name":"Travel Drone Case - UPGRADE","id":592,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Travel Drone Case - UPGRADE","discountAmount":0,"discountPercentage":0}]
};
...
const shippables = [{"id":587,"name":"Drone"},{"id":589,"name":"Drone Filter - Single"},{"id":591,"name":"Drone Propeller Blade - 8 Pieces"}];
...
async function createOrderViaWallet(confirmationToken, paymentMethodId) {
  ...
  const orderData = {
    pageId: "BogYOmrzFU75ipHqKFzj46dXDANU8tLQzJEtWOfbjivjfxE8uVGEDaRSI_kYLRIJ",
    action: "process",
...
const getStates = async (countryIso2Code) => {
  ...
  try {
    if (!countriesStatesCache) {
      const res = await fetch('/69ba5010deba85a3f7853271-preview/scripts/countriesData/countriesStates.json', { cache: 'no-store' });
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "BFalcon-Checkout", pageType: "Checkout" },
    };
